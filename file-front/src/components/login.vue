      ...
      if (this.id == "" || this.password == "") {
        ...
        axios({
          ...
          if (response.data.code == 200) {
            ...
            this.$store.commit('setUploadable', response.data.data.user.upload)
            this.$store.commit('setDownloadable', response.data.data.user.download)
            this.$store.commit('setDeletable', response.data.data.user.delete)
