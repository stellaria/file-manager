<template>
  <div>
    <el-button icon="el-icon-arrow-left" @click="handle2last" size="mini" style="float: left;"></el-button>
    <el-upload
      style="float: right;"
      class="upload-demo"
      ref="upload"
    ...
    >
      ...
      <el-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">上传到这里</el-button>
    </el-upload>
    <el-table
      ref="singleTable"
    ...
    >
      <el-table-column property="date" style="width: 100%">
        <template slot-scope="scope">
          <div @click="hanld2name(scope.row.name)" style="cursor: pointer;">
      ...
      <el-table-column width="300">
        ...
        <template slot-scope="scope">
          ...
          <el-button size="mini" @click="handleDelete(scope.row.name)" circle>
...
export default {
  ...
  methods: {
    init() {
      api
        .getFileList({ current: "/file/" + this.$store.state.username })
        .then(res => {
          //console.log(res)
    ...
    handleDownload(n) {
      var filePath = this.his.join("/") + "/" + n;
      api.download({file: filePath ,username: this.$store.state.username}).then(res => {
